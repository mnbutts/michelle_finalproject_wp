=== Plugin Name ===
Contributors: ounziw 
Donate link: https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=7VZG26X3DCKLN
Tags: show, id, admin, post, theme
...
If you use Version 1.0, please update. 
...
= 2.5 =
fix for notice when in trash.
= 2.4 =
span class="wp-ui-text-primary" added. For more readability.
= 2.3 =
indent and spacing fix
= 2.2 =
