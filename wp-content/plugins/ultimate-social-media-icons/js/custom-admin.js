...
function sfsi_update_step7() {
	...
	e = SFSI("#sfsi_popup_font option:selected").val(), t = SFSI("#sfsi_popup_fontStyle option:selected").val(), 
    color = SFSI("input[name='sfsi_popup_fontColor']").val(), n = SFSI("input[name='sfsi_popup_fontSize']").val(), o = SFSI("input[name='sfsi_popup_background_color']").val(), a = SFSI("input[name='sfsi_popup_border_color']").val(), r = SFSI("input[name='sfsi_popup_border_thickness']").val(), c = SFSI("input[name='sfsi_popup_border_shadow']:checked").val(), p = SFSI("input[name='sfsi_Show_popupOn']:checked").val(), _ = [];
...
function create_suscriber_form()
{
	...
	SFSI('input[name="sfsi_form_heading_fontsize"]').val() != "" ? (SFSI(".sfsi_subscribe_Popinner > form > h5").css({"font-size": parseInt(SFSI('input[name="sfsi_form_heading_fontsize"]').val())})) : '';
	...
	SFSI('input[name="sfsi_form_button_fontsize"]').val() != "" ? (SFSI(".sfsi_subscribe_Popinner").find('input[name="subscribe"]').css({"font-size": parseInt(SFSI('input[name="sfsi_form_button_fontsize"]').val())})) : '';
